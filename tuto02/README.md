...
Mettre le paramètre "Inactiviy timeout" à 300.</br>
Mettre le paramètre "Inactive agent unenrollment timeout" à 330.</br>
=> 300s = 5mn car ce Fleet est un container qui sera automatiquement détruit après 5m d'inactivité.</br>
